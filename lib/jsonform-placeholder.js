...
var fileDisplayTemplate = '<div class="_jsonform-preview">' +
  ...
  '<% } %>' +
  '</div>' +
  '<a href="#" class="ui button btn _jsonform-delete"><i class="icon-remove" title="Remove"></i></a> ';
...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="ui icon button btn _jsonform-array-addmore"><i class="icon-plus-sign add sign icon" title="Add new"></i></a> ' +
        '<a href="#" class="ui icon button btn _jsonform-array-deletelast"><i class="icon-minus-sign minus sign icon" title="Delete last"></i></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '</div>' +
      '<a href="#" class="btn ui icon button _jsonform-array-addmore"><i class="icon-plus-sign add sign icon" title="Add new"></i></a> ' +
      '<a href="#" class="btn  ui icon button  _jsonform-array-deleteitem"><i class="icon-minus-sign minus sign icon" title="Delete item"></i></a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
  ...
  'submit':{
    'template':'<input type="submit" <% if (id) { %> id="<%= id %>" <% } %> class="btn btn-primary ui button <%= elt.htmlClass?elt.htmlClass:"" %>" value="<%= value || node.title %>"<%= (node.disabled? " disabled" : "")%>/>'
  },
  'button':{
